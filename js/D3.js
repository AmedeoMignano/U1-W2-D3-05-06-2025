...
*/
console.log(
  "Before removing female characters, charatcer names are: " +
    charactersNames.length
);
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let h = 0; h < charactersNames.length; h++) {
    if (femaleCharacters[i].name === charactersNames[h]) {
      charactersNames.splice(h, 1);
    }
  }
}
console.log(
  "After removing female characters, charatcer names are: " +
    charactersNames.length
);
/* --EXTRA-- ESERCIZIO 10
